...
sys.path.insert(0, os.path.abspath('../src/bloch_distribution'))
...
htmlhelp_basename = 'Blochdistributiondoc'
...
latex_documents = [
  ('index', 'Blochdistribution.tex', 'Bloch distribution Documentation',
...
man_pages = [
    ('index', 'blochdistribution', 'Bloch distribution Documentation',
     ['Jonathan Gross'], 1)
]
...
texinfo_documents = [
  ('index', 'Blochdistribution', 'Bloch distribution Documentation',
   'Jonathan Gross', 'Blochdistribution', 'One line description of project.',
   'Miscellaneous'),
]
